---
name: analyze-repo
description: Detect languages, frameworks, build systems, dependencies, databases, and environment variables in a repository as the first step toward containerization. Use BEFORE generating a Dockerfile, fixing a Dockerfile, or generating Kubernetes manifests. Triggers include "analyze my repo", "what is this project", "detect my stack", "containerize this app", or any container-generation request where the stack hasn't been established.
